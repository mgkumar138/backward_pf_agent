...
ax1.set_ylabel('$\Delta$ percentage of cells')
# ax2.set_ylabel('Final Value Loss')
# ax2.set_yscale('log')
plt.title('Reward Discount Factor')
ax1.grid(True,alpha=0.3)
plt.savefig(f'./figs/alt_soln/gamma_{N}N_{sigma_init}sigma_ax1.svg', bbox_inches='tight')
...
ax1.grid(True,alpha=0.3)
plt.savefig(f'./figs/alt_soln/N_{gamma}g_{sigma_init}sigma_ax1.svg', bbox_inches='tight')
...
plt.savefig(f'./figs/alt_soln/sigma_{N}N_{gamma}g_ax1.svg', bbox_inches='tight')
